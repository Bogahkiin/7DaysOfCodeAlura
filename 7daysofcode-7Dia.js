...
const paragrafoDigitosCalculadora =
  document.getElementById("texto-calculadora");
...
function segundoNumero(x) {
  if (digitou1oNumero == true && operacaoFoiEscolhida == false) {
    // caracteres do primeiro número
    paragrafoDigitosCalculadora.innerText += x;
    primeiroNum += x;
  }
  if (operacaoFoiEscolhida == true) {
    // caracteres do segundo número
    paragrafoDigitosCalculadora.innerText += x;
    segundoNum += x;
  }
}
