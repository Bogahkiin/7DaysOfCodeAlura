...
function primeiroDia() {
  ...
  if (
    ...
    // junto ficou confuso
    alert(
      "Só sabendo o desafio para entender, mas: As variáveis numeroUm e stringUm tem o mesmo valor, mas tipos diferentes. As variáveis numeroTrinta e stringTrinta tem o mesmo valor e mesmo tipo. As variáveis numeroDez e stringDez tem o mesmo valor, mas tipos diferentes."
    );
  } else {
    alert(
      "As variáveis numeroUm e stringUm não tem o mesmo valor. As variáveis numeroTrinta e stringTrinta não tem o mesmo tipo. As variáveis numeroDez e stringDez não tem o mesmo valor."
    );
  }
}
